...
public class KakaoPay {
	...
	public String kakaoPayReady(int count) {
		...
		params.add("cancel_url", "http://j3b102.p.ssafy.io/"); // 결제 취소시 redirect할 url (결제 페이지로 바꿀 예정)
		params.add("fail_url", "http://j3b102.p.ssafy.io/"); // 결제 실패시 redirect할 url (결제 페이지로 바꿀 예정)
